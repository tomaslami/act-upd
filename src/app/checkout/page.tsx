...
const CheckoutSummaryContent = () => {
  ...
  const { totalPrice, reservationPrice } = getCoursePrices()
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-col space-y-2 bg-blue-50 p-4 rounded-lg mb-4">
                      <div className="flex justify-between text-sm text-gray-600">
                        ...
                        <span className="line-through">${totalPrice} ARS</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Reserva {isSpecialCourse(title) ? "" : "(30%)"}</span>
